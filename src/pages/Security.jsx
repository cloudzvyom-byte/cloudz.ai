      ...
      <main className="relative z-10 pt-32 pb-20 px-6">
        ...
        >
          ...
          <div className="prose prose-sm md:prose-base text-gray-700 leading-relaxed space-y-6">
            ...
            <section>
              <h2 className="text-xl font-bold text-black mb-3">1. Infrastructure Security</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-black mb-3">2. Data Protection</h2>
              <ul className="list-disc pl-5 space-y-1">
            ...
            <section>
              <h2 className="text-xl font-bold text-black mb-3">3. AI Safety Measures</h2>
              <ul className="list-disc pl-5 space-y-1">
            ...
            <section>
              <h2 className="text-xl font-bold text-black mb-3">4. Access Control</h2>
              <ul className="list-disc pl-5 space-y-1">
            ...
            <section>
              <h2 className="text-xl font-bold text-black mb-3">5. Incident Response</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-black mb-3">6. User Responsibilities</h2>
              <p>Users should:</p>
              <ul className="list-disc pl-5 space-y-1">
            ...
            <section>
              <h2 className="text-xl font-bold text-black mb-3">7. Reporting Vulnerabilities</h2>
