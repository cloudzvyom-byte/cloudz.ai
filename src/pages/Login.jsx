        ...
        <div className="rounded-[32px] border border-white/30 bg-black/20 p-10 shadow-[0_20px_50px_rgba(0,0,0,0.3)] backdrop-blur-2xl text-white">
          ...
          <div className="space-y-5">
            ...
            <button
              ...
              disabled={loading}
              className="mt-3 flex w-full items-center justify-center gap-2 rounded-xl border border-white/30 bg-black/30 px-4 py-3.5 text-sm font-semibold text-white shadow-lg transition-all hover:bg-black/50 hover:translate-y-[-2px] hover:shadow-xl disabled:opacity-50 disabled:hover:translate-y-0"
            >
